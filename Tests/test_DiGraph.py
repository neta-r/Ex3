...
class TestDiGraph(TestCase):
    ...
    def test_remove_edge(self):
        ...
        self.assertFalse(graph.all_out_edges_of_node(5).__contains__(9))
        self.assertFalse(graph.all_in_edges_of_node(9).__contains__(5))
        graph.remove_edge(7, 8)
        self.assertEqual(graph.v_size(), 10)
        self.assertEqual(graph.e_size(), 18)
        self.assertFalse(graph.all_out_edges_of_node(7).__contains__(8))
        self.assertFalse(graph.all_in_edges_of_node(8).__contains__(7))
        ...
        self.assertFalse(graph.all_out_edges_of_node(59).__contains__(8))
        self.assertFalse(graph.all_in_edges_of_node(7).__contains__(59))
